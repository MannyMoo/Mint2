...
// ========================= 3 Body Decays ======================
int NamedDecayTreeList::make3BodyListForRunningWidth(){
    
    DecayTree* dk=0;
    
    // a1(1260) 
    dk = new DecayTree(20213);
    ...
    dk = new DecayTree(20213);
    dk->addDgtr(211, 100113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    dk->getVal().setL(2);
    this->add(*dk);
    ...
    dk = new DecayTree(20213);
    dk->addDgtr(211, 9000221)->addDgtr(211,-211);
    this->add(*dk);
    ...
    dk = new DecayTree(20213);
    dk->addDgtr(321, 323)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    
    // pi(1300)
    dk = new DecayTree(100211);
    dk->addDgtr(211, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    delete dk;
    ...
    dk = new DecayTree(100211);
    dk->addDgtr(211, 9981)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "NonRes"));  
    delete dk;
    
    dk = new DecayTree(100211);
    dk->addDgtr(211, 9993)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "NonRes"));  
    delete dk;
    
    //K1(1270)
    dk = new DecayTree(10323);
    dk->addDgtr(321, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    delete dk;
    
    dk = new DecayTree(10323);
    dk->addDgtr(321, 223)->addDgtr(211,-211);
    this->add(*dk);
    delete dk;
    
    dk = new DecayTree(10323);
    dk->addDgtr(211, 323)->addDgtr(321,-211);
    this->add(*dk);
    dk->getVal().setL(2);
    this->add(*dk);
    delete dk;
    ...
    dk = new DecayTree(10323);
    dk->addDgtr(211, 10321)->addDgtr(321,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "Lass"));  
    delete dk;
    
    dk = new DecayTree(10323);
    dk->addDgtr(321, 9010221)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "Flatte"));  
    delete dk;
    
    //K1(1400)
    dk = new DecayTree(20323);
    dk->addDgtr(321, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    delete dk;
...
int NamedDecayTreeList::makeKKPi0List(){
  //D0 -> (K*(892)+ -> K+ pi0) K-
  DecayTree dkKstKm(421);
  dkKstKm.addDgtr(-321,323)->addDgtr(321,111);
  add(dkKstKm);

  //D0 -> (K*(1410)+ -> K+ pi0) K-
  DecayTree dkKst_1410Km(421);
...
int NamedDecayTreeList::makePsiKpipiList(){
    ...
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "MI_10323"));
    dk->getVal().setL(1);
    this->add(*dk);
    dk->getVal().setL(2);
    this->add(*dk);
    ...
    this->add(AmpInitialiser(*dk, "MI_10323"));
    this->add(AmpInitialiser(*dk, "MI_10323GS"));
    this->add(*dk);
    dk->getVal().setL(1);
    this->add(*dk); 
    this->add(AmpInitialiser(*dk, "GS"));
    ...
    // B->psi K1(1270); K1->K sigma; sigma->pi pi  
    dk = new DecayTree(521);
    dk->addDgtr(100443, 10323)->addDgtr(321, 9000221)->addDgtr(211,-211);
    this->add(*dk); 
    this->add(AmpInitialiser(*dk, "Bugg"));
    dk->getVal().setL(1);
    this->add(*dk);
    ...
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "MI_100323"));
    dk->getVal().setL(1);
    this->add(*dk);
    dk->getVal().setL(2);
    this->add(*dk);
    ...
    this->add(AmpInitialiser(*dk, "MI_10323"));
    this->add(AmpInitialiser(*dk, "MI_10323GS"));
    this->add(AmpInitialiser(*dk, "MI_10323RhoOmegaGS"));
    this->add(*dk);
    dk->getVal().setL(1);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    ...
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "MI_100321"));
    this->add(AmpInitialiser(*dk, "MI_100321GS"));
    ...
    this->add(*dk); 
    this->add(AmpInitialiser(*dk, "Flatte")); 
    this->add(AmpInitialiser(*dk, "MI_9999992"));
    this->add(AmpInitialiser(*dk, "MI_9999992Flatte"));
    delete dk;
    ...
    this->add(AmpInitialiser(*dk, "Bugg"));
    this->add(AmpInitialiser(*dk, "MI_9999992"));
    this->add(AmpInitialiser(*dk, "MI_9999992Bugg"));
    delete dk;
    ...
    dk->addDgtr(&Z);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "MI_9999994"));
    delete dk;
    ...
    dk->addDgtr(&Z);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "MI_9999993"));
    delete dk;
    ...
    dk->addDgtr(&Z);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "MI_9999995"));
    delete dk;
    ...
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "MI_9999994"));
    this->add(AmpInitialiser(*dk, "MI_9999994GS"));
    delete dk;
    ...
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "MI_9999993"));
    this->add(AmpInitialiser(*dk, "MI_9999993GS"));
    delete dk;
    ...
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "MI_9999995"));
    this->add(AmpInitialiser(*dk, "MI_9999995GS"));
    delete dk;
    ...
    // B->XP K; XP-> psi rho
    dk = new DecayTree(521);
    dk->addDgtr(321, 92)->addDgtr(100443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    dk = new DecayTree(521);
    dk->addDgtr(321, 97)->addDgtr(100443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    dk = new DecayTree(521);
    dk->addDgtr(321, 9991)->addDgtr(100443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    // B->XP pi; XP-> psi K*
    dk = new DecayTree(521);
    dk->addDgtr(211, 92)->addDgtr(100443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 97)->addDgtr(100443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 9991)->addDgtr(100443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    // B->XS K; XS-> psi rho
    dk = new DecayTree(521);
    dk->addDgtr(321, 91)->addDgtr(100443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    dk = new DecayTree(521);
    dk->addDgtr(321, 96)->addDgtr(100443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    dk = new DecayTree(521);
    dk->addDgtr(321, 9981)->addDgtr(100443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    // B->XS pi; XS-> psi K*
    dk = new DecayTree(521);
    dk->addDgtr(211, 91)->addDgtr(100443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 96)->addDgtr(100443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    dk = new DecayTree(521);
    dk->addDgtr(211, 9981)->addDgtr(100443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    // B->XA K; XA-> psi rho
    dk = new DecayTree(521);
    dk->addDgtr(321, 94)->addDgtr(100443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    dk = new DecayTree(521);
    dk->addDgtr(321, 99)->addDgtr(100443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    // B->XA pi; XA-> psi K*
    dk = new DecayTree(521);
    dk->addDgtr(211, 9983)->addDgtr(100443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 99)->addDgtr(100443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    ...
    // B->XV K; XV-> psi f2
    dk = new DecayTree(521);
    dk->addDgtr(321, 93)->addDgtr(100443, 225)->addDgtr(211,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(321, 98)->addDgtr(100443, 225)->addDgtr(211,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(321, 9993)->addDgtr(100443, 225)->addDgtr(211,-211);
    this->add(*dk);
    delete dk;

    // B->XV pi; XV-> psi K2*
    dk = new DecayTree(521);
    dk->addDgtr(211, 93)->addDgtr(100443, 315)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 98)->addDgtr(100443, 315)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 9993)->addDgtr(100443, 315)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    ...
    this->add(AmpInitialiser(*dk, "MI_9983_"));
    ...
    this->add(AmpInitialiser(*dk, "MI_9983_"));
    this->add(AmpInitialiser(*dk, "MI_9983_GS"));
    dk->getVal().setL(1);
    this->add(AmpInitialiser(*dk, "RHO_OMEGA"));
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
...
int NamedDecayTreeList::makeJpsiKpipiList(){
    ...
    this->add(AmpInitialiser(*dk, "Flatte"));
    this->add(AmpInitialiser(*dk, "MI_10323"));
    this->add(AmpInitialiser(*dk, "MI_10323Flatte"));
    dk->getVal().setL(1);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "Flatte"));
    dk->getVal().setL(2);
    ...
    this->add(AmpInitialiser(*dk, "MINUS")); 
    this->add(AmpInitialiser(*dk, "MI_10323"));
    this->add(AmpInitialiser(*dk, "MI_10323Lass"));
    dk->getVal().setL(1);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "Lass"));
    dk->getVal().setL(2);
    ...
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "MI_100323"));
    this->add(AmpInitialiser(*dk, "MI_100323GS"));
    this->add(AmpInitialiser(*dk, "MI_100323RhoOmegaGS"));
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "PLUS"));
    this->add(AmpInitialiser(*dk, "ZERO"));
    this->add(AmpInitialiser(*dk, "MINUS"));  
    ...
    this->add(AmpInitialiser(*dk, "GS"));
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "MI_10321"));
    this->add(AmpInitialiser(*dk, "MI_10321GS"));
    this->add(AmpInitialiser(*dk, "MI_10321RhoOmegaGS"));
    this->add(*dk);
    delete dk;
    ...
    this->add(AmpInitialiser(*dk, "ZERO"));
    this->add(AmpInitialiser(*dk, "MINUS"));   
    this->add(AmpInitialiser(*dk, "MI_10325"));
    dk->getVal().setL(2);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "PLUS"));
    this->add(AmpInitialiser(*dk, "ZERO"));
    ...
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "MI_10325"));
    this->add(AmpInitialiser(*dk, "MI_10325GS"));
    this->add(AmpInitialiser(*dk, "MI_10325RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "PLUS"));
    this->add(AmpInitialiser(*dk, "ZERO"));
    this->add(AmpInitialiser(*dk, "MINUS"));    
    dk->getVal().setL(2);
    ...
    this->add(AmpInitialiser(*dk, "Flatte"));
    this->add(AmpInitialiser(*dk, "MI_10325"));
    this->add(AmpInitialiser(*dk, "MI_10325Flatte"));
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "PLUS"));
    this->add(AmpInitialiser(*dk, "ZERO"));
    this->add(AmpInitialiser(*dk, "MINUS"));   
    ...
    this->add(AmpInitialiser(*dk, "ZERO"));
    this->add(AmpInitialiser(*dk, "MINUS"));
    this->add(AmpInitialiser(*dk, "MI_100325"));
    delete dk;
    ...
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    this->add(AmpInitialiser(*dk, "MI_100325"));
    this->add(AmpInitialiser(*dk, "MI_100325GS"));
    this->add(AmpInitialiser(*dk, "MI_100325RhoOmegaGS"));
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "PLUS"));
    this->add(AmpInitialiser(*dk, "ZERO"));
    this->add(AmpInitialiser(*dk, "MINUS")); 
    ...
    // B->pi+ X(4260); X->Z+ pi-; Z+->psi K+  
    dk = new DecayTree(521);
    dk->addDgtr(211, 9999992)->addDgtr(-211, 9999993)->addDgtr(443,321);
    this->add(*dk); 
    this->add(AmpInitialiser(*dk, "MI_9999992"));
    this->add(AmpInitialiser(*dk, "MI_9999993"));
    delete dk;
    ...
    // B->pi- X(4260); X->Z- K+; Z-->psi pi-  
    dk = new DecayTree(521);
    dk->addDgtr(-211, 9999992)->addDgtr(321, 9999993)->addDgtr(443,-211);
    this->add(AmpInitialiser(*dk, "MI_9999992"));
    this->add(AmpInitialiser(*dk, "MI_9999993"));
    this->add(*dk); 
    delete dk;
    ...
    // B->pi X(4260); X->K0* psi; K0*->K pi  
    dk = new DecayTree(521);
    dk->addDgtr(211, 9999992)->addDgtr(443, 10311)->addDgtr(321,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "MI_9999992"));
    delete dk;
    ...
    // B->XP K; XP-> psi rho
    dk = new DecayTree(521);
    dk->addDgtr(321, 92)->addDgtr(443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    dk = new DecayTree(521);
    dk->addDgtr(321, 97)->addDgtr(443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    dk = new DecayTree(521);
    dk->addDgtr(321, 9991)->addDgtr(443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    // B->XP pi; XP-> psi K*
    dk = new DecayTree(521);
    dk->addDgtr(211, 92)->addDgtr(443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 97)->addDgtr(443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 9991)->addDgtr(443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    // B->XS K; XS-> psi rho
    dk = new DecayTree(521);
    dk->addDgtr(321, 91)->addDgtr(443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    dk = new DecayTree(521);
    dk->addDgtr(321, 96)->addDgtr(443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    dk = new DecayTree(521);
    dk->addDgtr(321, 9981)->addDgtr(443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    // B->XS pi; XS-> psi K*
    dk = new DecayTree(521);
    dk->addDgtr(211, 91)->addDgtr(443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 96)->addDgtr(443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    dk = new DecayTree(521);
    dk->addDgtr(211, 9981)->addDgtr(443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    // B->XA K; XA-> psi rho
    dk = new DecayTree(521);
    dk->addDgtr(321, 94)->addDgtr(443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    dk = new DecayTree(521);
    dk->addDgtr(321, 99)->addDgtr(443, 113)->addDgtr(211,-211);
    this->add(*dk);
    this->add(AmpInitialiser(*dk, "GS"));  
    this->add(AmpInitialiser(*dk, "RhoOmegaGS"));
    delete dk;
    ...
    // B->XA pi; XA-> psi K*
    dk = new DecayTree(521);
    dk->addDgtr(211, 9983)->addDgtr(443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 99)->addDgtr(443, 313)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    ...
    // B->XV K; XV-> psi f2
    dk = new DecayTree(521);
    dk->addDgtr(321, 93)->addDgtr(443, 225)->addDgtr(211,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(321, 98)->addDgtr(443, 225)->addDgtr(211,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(321, 9993)->addDgtr(443, 225)->addDgtr(211,-211);
    this->add(*dk);
    delete dk;

    // B->XV pi; XV-> psi K2*
    dk = new DecayTree(521);
    dk->addDgtr(211, 93)->addDgtr(443, 315)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 98)->addDgtr(443, 315)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;

    dk = new DecayTree(521);
    dk->addDgtr(211, 9993)->addDgtr(443, 315)->addDgtr(321,-211);
    this->add(*dk);
    delete dk;
    ...
    this->add(AmpInitialiser(*dk, "NonResPow_9981"));
    this->add(AmpInitialiser(*dk, "NonResPow_9991_9981"));
    this->add(AmpInitialiser(*dk, "MI_9991"));
    delete dk;
...
int NamedDecayTreeList::make4PiList() {
  ...
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResExp"));
  add(AmpInitialiser(*dk, "MI_9983"));
  add(AmpInitialiser(*dk, "MI_9983NonResExp"));
  add(AmpInitialiser(*dk, "MI_9981"));
  add(AmpInitialiser(*dk, "MI_9981NonResExp"));
  delete dk;    
  ...
  dk->addDgtr(113)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonResGS"));
  add(AmpInitialiser(*dk, "NonResExpGS"));
  dk->getVal().setL(1);
  add(*dk);
  add(AmpInitialiser(*dk, "NonResGS"));
  add(AmpInitialiser(*dk, "NonResExpGS"));
  ...
  //D0 -> NA pi-, NA->NT pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9983)->addDgtr(211, 9985)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResExp"));
  add(AmpInitialiser(*dk, "MI_9983"));
  ...
  //D0 -> NA pi-, NA->rho pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9983)->addDgtr(211, 113)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonResGS"));
  add(AmpInitialiser(*dk, "NonResPowGS"));
  add(AmpInitialiser(*dk, "NonResExpGS"));
  delete dk;  
    
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9983)->addDgtr(211, 100113)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResPow"));
  add(AmpInitialiser(*dk, "NonResExp"));
  delete dk;  
    
  dk = new DecayTree(421);
  a1 = new DecayTree(9983);
  a1->getVal().setL(2);
  ...
  //D0 -> NA pi-, NA->sigma pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9983)->addDgtr(211, 999001)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResExp"));
  add(AmpInitialiser(*dk, "NonResBugg"));
  add(AmpInitialiser(*dk, "NonResExpBugg"));
  add(AmpInitialiser(*dk, "Bugg"));
  delete dk;  

  //D0 -> NA pi-, NA->f0(1370) pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9983)->addDgtr(211, 30221)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResExp"));
  add(AmpInitialiser(*dk, "NonResBugg"));
  ...
  //D0 -> NA pi-, NA->f2(1270) pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9983)->addDgtr(211, 225)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResExp"));
  delete dk;  
  ...
  //D0 -> NV pi-, NV->rho pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9993)->addDgtr(211, 113)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonResGS"));
  add(AmpInitialiser(*dk, "NonResPowGS"));
  add(AmpInitialiser(*dk, "NonResExpGS"));
  ...
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9993)->addDgtr(211, 100113)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResPow"));
  add(AmpInitialiser(*dk, "NonResExp"));
  ...
  //D0 -> NPT pi-, NPT->rho pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9975)->addDgtr(211, 113)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonResGS"));
  add(AmpInitialiser(*dk, "NonResPowGS"));
  add(AmpInitialiser(*dk, "NonResExpGS"));
  ...
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9975)->addDgtr(211, 100113)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResPow"));
  add(AmpInitialiser(*dk, "NonResExp"));
  ...
  //D0 -> NPT pi-, NPT->sigma pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9975)->addDgtr(211, 999001)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResExp"));
  add(AmpInitialiser(*dk, "NonResBugg"));
  ...
  //D0 -> NPT pi-, NPT->f0(1370) pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9975)->addDgtr(211, 30221)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResExp"));
  add(AmpInitialiser(*dk, "NonResBugg"));
  ...
  //D0 -> NPT pi-, NPT->f2(1270) pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9975)->addDgtr(211, 225)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResExp"));
  delete dk;     
  ...
  //D0 -> NT pi-, NT->rho pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9985)->addDgtr(211, 113)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonResGS"));
  add(AmpInitialiser(*dk, "NonResPowGS"));
  add(AmpInitialiser(*dk, "NonResExpGS"));
  ...
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9985)->addDgtr(211, 100113)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResPow"));
  add(AmpInitialiser(*dk, "NonResExp"));
  ...
  //D0 -> NT pi-, NT->f2(1270) pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 9985)->addDgtr(211, 225)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResExp"));
  delete dk;   
  ...
  add(AmpInitialiser(*dk, "NonRes"));
  add(AmpInitialiser(*dk, "NonResExp"));
  add(AmpInitialiser(*dk, "HistoPS_225"));
  delete dk;   
  ...
  this->add(AmpInitialiser(*dk, "GS")); 
  this->add(AmpInitialiser(*dk, "RhoOmegaGS")); 
  this->add(AmpInitialiser(*dk, "MI_20213"));   
  this->add(AmpInitialiser(*dk, "MI_20213GS"));     
  delete dk;
  ...
  this->add(AmpInitialiser(*dk, "Bugg"));
  this->add(AmpInitialiser(*dk, "MI_20213"));
  this->add(AmpInitialiser(*dk, "MI_20213Bugg"));   
  this->add(AmpInitialiser(*dk, "MI_999001"));   
  delete dk;
  ...
  //D0 -> a1(1260)pi-, a1(1260)->f0(1370) pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 20213)->addDgtr(211,30221)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "HistoPS_30221"));
  add(AmpInitialiser(*dk, "Bugg"));
  delete dk;

  //D0 -> a1(1260)pi-, a1(1260)->f0(980) pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 20213)->addDgtr(211,9010221)->addDgtr(211, -211);
  add(*dk);
  this->add(AmpInitialiser(*dk,"Flatte"));
  delete dk;

  //D0 -> a1(1260)pi-, a1(1260)->NS pi+
  dk = new DecayTree(421);
  dk->addDgtr(-211, 20213)->addDgtr(211,9981)->addDgtr(211, -211);
  add(*dk);
  this->add(AmpInitialiser(*dk,"NonRes"));
  this->add(AmpInitialiser(*dk,"NonResExp"));
  this->add(AmpInitialiser(*dk,"TopHats"));
  ...
  this->add(AmpInitialiser(*dk, "RhoOmegaGS")); 
    ...
    this->add(AmpInitialiser(*dk, "RhoOmegaGS")); 
    this->add(AmpInitialiser(*dk, "SBW_"));   
    this->add(AmpInitialiser(*dk, "MI_9920213"));   
    this->add(AmpInitialiser(*dk, "MI_9920213GS"));
    delete dk;
    ...
    this->add(AmpInitialiser(*dk, "Bugg"));
    this->add(AmpInitialiser(*dk, "MI_9920213"));   
    this->add(AmpInitialiser(*dk, "MI_9920213Bugg"));   
    delete dk;
  ...
  //D0 -> rho(1450)rho(770), rho(770)->pi+pi-  [S-WAVE]
  dk = new DecayTree(421);
  dk->addDgtr(100113)->addDgtr(211, -211);
  dk->addDgtr(113)->addDgtr(211, -211);
  add(*dk);
  ...
  //D0 -> rho(1450)rho(770), rho(770)->pi+pi-  [P-WAVE]
  dk = new DecayTree(421);
  dk->addDgtr(100113)->addDgtr(211, -211);
  dk->addDgtr(113)->addDgtr(211, -211);
  dk->getVal().setL(1);
  ...
  //D0 -> rho(1450)rho(770), rho(770)->pi+pi-  [D-WAVE]
  dk = new DecayTree(421);
  dk->addDgtr(100113)->addDgtr(211, -211);
  dk->addDgtr(113)->addDgtr(211, -211);
  dk->getVal().setL(2);
  ...
  //D0 -> rho(1450)rho(1450), rho(770)->pi+pi-  [S-WAVE]
  dk = new DecayTree(421);
  dk->addDgtr(100113)->addDgtr(211, -211);
  dk->addDgtr(100113)->addDgtr(211, -211);
  add(*dk);
  ...
  //D0 -> rho(1450)rho(1450), rho(1450)->pi+pi-  [P-WAVE]
  dk = new DecayTree(421);
  dk->addDgtr(100113)->addDgtr(211, -211);
  dk->addDgtr(100113)->addDgtr(211, -211);
  dk->getVal().setL(1);
  ...
  //D0 -> rho(1450)rho(1450), rho(770)->pi+pi-  [D-WAVE]
  dk = new DecayTree(421);
  dk->addDgtr(100113)->addDgtr(211, -211);
  dk->addDgtr(100113)->addDgtr(211, -211);
  dk->getVal().setL(2);
  ...
  dk->addDgtr(9981)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonResExpFlatte"));
  add(AmpInitialiser(*dk, "Flatte"));
  delete dk;

  dk = new DecayTree(421);
  dk->addDgtr(9010221)->addDgtr(211, -211);
  dk->addDgtr(9991)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonResExpFlatte"));
  add(AmpInitialiser(*dk, "Flatte"));
  delete dk;

  //D0 -> f0(1370)pi-pi+, f0(980)->pi+pi-
  dk = new DecayTree(421);
  dk->addDgtr(30221)->addDgtr(211, -211);
  dk->addDgtr(9010221)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "Flatte"));
  add(AmpInitialiser(*dk, "FlatteBugg"));
  add(AmpInitialiser(*dk, "FlatteHistoPS_30221"));
  add(AmpInitialiser(*dk, "HistoPS_30221"));
  delete dk;

  //D0 -> f0(1500)pi-pi+, f0(980)->pi+pi-
  dk = new DecayTree(421);
  dk->addDgtr(9030221)->addDgtr(211, -211);
  dk->addDgtr(9010221)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "Flatte"));
  add(AmpInitialiser(*dk, "FlatteBugg"));
  ...
  //D0 -> f0(1370)pi-pi+, f0(1370)->pi+pi-
  dk = new DecayTree(421);
  dk->addDgtr(30221)->addDgtr(211, -211);
  dk->addDgtr(30221)->addDgtr(211, -211);
  add(*dk);
  ...
  //D0 -> f0(1370)pi-pi+, f0(1500)->pi+pi-
  dk = new DecayTree(421);
  dk->addDgtr(9030221)->addDgtr(211, -211);
  dk->addDgtr(30221)->addDgtr(211, -211);
  add(*dk);
  ...
  //D0 -> f0(1500)pi-pi+, f0(1500)->pi+pi-
  dk = new DecayTree(421);
  dk->addDgtr(9030221)->addDgtr(211, -211);
  dk->addDgtr(9030221)->addDgtr(211, -211);
  add(*dk);
  ...
  //D0 -> f0(980)->pi-pi+, sigma_1->pi+pi-
  dk = new DecayTree(421);
  dk->addDgtr(9010221)->addDgtr(211, -211);
  dk->addDgtr(999001)->addDgtr(211, -211);
  add(*dk);
  this->add(AmpInitialiser(*dk, "Flatte"));
  this->add(AmpInitialiser(*dk, "BuggFlatte"));
  this->add(AmpInitialiser(*dk, "MI_999001Flatte")); 
  this->add(AmpInitialiser(*dk, "Bugg"));
  this->add(AmpInitialiser(*dk, "MI_999001"));  
  delete dk;

  //D0 -> f0(1370)->pi-pi+, sigma_1->pi+pi-
  dk = new DecayTree(421);
  dk->addDgtr(30221)->addDgtr(211, -211);
  dk->addDgtr(999001)->addDgtr(211, -211);
  add(*dk);
  ...
  this->add(AmpInitialiser(*dk, "MI_999001"));
  add(AmpInitialiser(*dk, "HistoPS_30221"));
  add(AmpInitialiser(*dk, "BuggHistoPS_30221"));  
  delete dk;

  //D0 -> f0(1500)->pi-pi+, sigma_1->pi+pi-
  dk = new DecayTree(421);
  dk->addDgtr(9030221)->addDgtr(211, -211);
  dk->addDgtr(999001)->addDgtr(211, -211);
  add(*dk);
  ...
  this->add(AmpInitialiser(*dk, "RhoOmegaGS"));   
  this->add(AmpInitialiser(*dk, "BuggRhoOmegaGS")); 
  this->add(AmpInitialiser(*dk, "MI_999001"));
  this->add(AmpInitialiser(*dk, "MI_999001GS"));  
  delete dk;  

  //D0 -> f0(980) rho(770), rho(770)->pi+pi-  
  dk = new DecayTree(421);
  dk->addDgtr(9010221)->addDgtr(211, -211);
  dk->addDgtr(113)->addDgtr(211, -211);
  add(*dk);
  this->add(AmpInitialiser(*dk, "GS"));  
  this->add(AmpInitialiser(*dk, "Flatte"));
  this->add(AmpInitialiser(*dk, "FlatteGS"));
  this->add(AmpInitialiser(*dk, "RhoOmegaGS"));   
  this->add(AmpInitialiser(*dk, "FlatteRhoOmegaGS")); 
  delete dk;  

  //D0 -> f0(1370) rho(770), rho(770)->pi+pi-  
  dk = new DecayTree(421);
  dk->addDgtr(30221)->addDgtr(211, -211);
  dk->addDgtr(113)->addDgtr(211, -211);
  add(*dk);
  ...
  this->add(AmpInitialiser(*dk, "BuggRhoOmegaGS"));
  add(AmpInitialiser(*dk, "HistoPS_30221"));
  add(AmpInitialiser(*dk, "GSHistoPS_30221")); 
  delete dk;

  //D0 -> f0(1500) rho(770), rho(770)->pi+pi-  
  dk = new DecayTree(421);
  dk->addDgtr(9030221)->addDgtr(211, -211);
  dk->addDgtr(113)->addDgtr(211, -211);
  add(*dk);
  ...
  // D0 -> f0(1370)Bkg pi-pi+, fo(1370)->NonRes pi+pi-
  dk = new DecayTree(421);
  dk->addDgtr(930221)->addDgtr(211, -211);
  dk->addDgtr(9993)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "NonResExp"));
  delete dk;
  ...
  this->add(AmpInitialiser(*dk, "GS"));  
  this->add(AmpInitialiser(*dk, "RhoOmegaGS")); 
  this->add(AmpInitialiser(*dk, "MI_100211"));  
  delete dk;
  ...
  add(*dk);
  add(AmpInitialiser(*dk, "Bugg"));
  add(AmpInitialiser(*dk, "BuggHistoPS_225"));
  add(AmpInitialiser(*dk, "HistoPS_225"));
  delete dk;
  ...
  add(AmpInitialiser(*dk, "Flatte"));
  add(AmpInitialiser(*dk, "HistoPS_225"));
  add(AmpInitialiser(*dk, "FlatteHistoPS_225"));
  delete dk;
  ...
  add(AmpInitialiser(*dk, "HistoPS_225"));
  add(AmpInitialiser(*dk, "HistoPS_225"));
  add(AmpInitialiser(*dk, "HistoPS_225_HistoPS_30221"));
  add(AmpInitialiser(*dk, "HistoPS_30221"));
  delete dk;
  ...
  dk->addDgtr(113)->addDgtr(211, -211);
  add(*dk);
  add(AmpInitialiser(*dk, "GS"));
  add(AmpInitialiser(*dk, "HistoPS_225"));
  add(AmpInitialiser(*dk, "GSHistoPS_225"));
  dk->getVal().setL(2);
  add(*dk);
  add(AmpInitialiser(*dk, "GS"));
  add(AmpInitialiser(*dk, "HistoPS_225"));
