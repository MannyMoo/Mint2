#ifndef __TIMEDEPENDENTGENERATOROLD_H__
#define __TIMEDEPENDENTGENERATOROLD_H__
...
class TimeDependentGeneratorOld {
...
public :
  ...
  */
  TimeDependentGeneratorOld(const std::string& name, const bool overwrite, TRandom3* rndm, double precision,
